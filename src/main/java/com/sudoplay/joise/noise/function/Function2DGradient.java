...
import com.sudoplay.joise.noise.worker.WorkerNoise2Gradient;
import com.sudoplay.joise.noise.worker.spi.IWorkerNoise2;

public class Function2DGradient implements
    IFunction2D {

  private IWorkerNoise2 worker;

  public Function2DGradient() {
    this.worker = new WorkerNoise2Gradient();
  }
  ...
  public double get(double x, double y, long seed, IInterpolator interpolator) {
    ...
    return Noise.interpolateXY2(x, y, xs, ys, x0, x1, y0, y1, seed, this.worker);
  }
}
