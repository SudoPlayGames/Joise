 ...
 */
public class ModuleFractalGradientBillowExample extends
    AbstractSplitExample {

  static {
    EXAMPLE_CLASS = ModuleFractalGradientBillowExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleFractal Gradient Billow Example";
  }

  @Override
  protected void run(SplitCanvas canvas) {
    BasisType basisType = BasisType.GRADIENT;
    FractalType fractalType = FractalType.BILLOW;
