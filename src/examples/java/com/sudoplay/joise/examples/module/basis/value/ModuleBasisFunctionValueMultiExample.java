 ...
 */
public class ModuleBasisFunctionValueMultiExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionValueMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction Value Multi Example";
  }
  ...
  protected void run(SplitCanvas canvas) {
    ...
    genNone.setType(ModuleFractal.FractalType.MULTI);
    genNone.setSeed(42);
    ...
    genLinear.setType(ModuleFractal.FractalType.MULTI);
    ...
    genCubic.setType(ModuleFractal.FractalType.MULTI);
    genCubic.setSeed(42);
    ...
    genQuintic.setType(ModuleFractal.FractalType.MULTI);
