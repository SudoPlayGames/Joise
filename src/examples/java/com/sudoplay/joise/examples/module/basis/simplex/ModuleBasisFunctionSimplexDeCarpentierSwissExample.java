 ...
 */
public class ModuleBasisFunctionSimplexDeCarpentierSwissExample extends
    AbstractSplitExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionSimplexDeCarpentierSwissExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction Simplex deCarpentierSwiss Example";
  }
