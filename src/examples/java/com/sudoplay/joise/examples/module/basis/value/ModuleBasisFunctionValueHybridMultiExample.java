 ...
 */
public class ModuleBasisFunctionValueHybridMultiExample extends
    AbstractSplitExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionValueHybridMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction Value HybridMulti Example";
  }
  ...
  protected void run(SplitCanvas canvas) {
    ...
    genNone.setType(ModuleFractal.FractalType.HYBRIDMULTI);
    genNone.setSeed(42);
    ...
    genLinear.setType(ModuleFractal.FractalType.HYBRIDMULTI);
    ...
    genCubic.setType(ModuleFractal.FractalType.HYBRIDMULTI);
    genCubic.setSeed(42);
    ...
    genQuintic.setType(ModuleFractal.FractalType.HYBRIDMULTI);
