 ...
 */
public class ModuleCombinerAvgExample extends
    AbstractSplitExample {

  static {
    EXAMPLE_CLASS = ModuleCombinerAvgExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleCombiner Avg Example";
  }
  ...
  protected void run(SplitCanvas canvas) {
    ...
    moduleCombiner.setType(ModuleCombiner.CombinerType.AVG);
    ...
    canvas.updateImage(
        ...
        "moduleCombiner: avg", moduleCombiner
    );
  }
}
