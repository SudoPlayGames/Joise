 ...
 */
public class ModuleFractalSimplexRidgeMultiExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleFractalSimplexRidgeMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleFractal Simplex RidgeMulti Example";
  }
