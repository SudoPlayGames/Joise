 ...
 */
public class ModuleBasisFunctionValueRidgeMultiExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionValueRidgeMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction Value RidgeMulti Example";
  }
