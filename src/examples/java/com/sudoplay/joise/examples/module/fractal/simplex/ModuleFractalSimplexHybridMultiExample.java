 ...
 */
public class ModuleFractalSimplexHybridMultiExample extends
    AbstractSplitExample {

  static {
    EXAMPLE_CLASS = ModuleFractalSimplexHybridMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleFractal Simplex HybridMulti Example";
  }
