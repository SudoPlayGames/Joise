 ...
 */
public class ModuleBasisFunctionWhiteBillowExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionWhiteBillowExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction White Billow Example";
  }
