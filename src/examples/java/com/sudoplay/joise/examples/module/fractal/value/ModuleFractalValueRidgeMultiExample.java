 ...
 */
public class ModuleFractalValueRidgeMultiExample extends
    AbstractSplitExample {

  static {
    EXAMPLE_CLASS = ModuleFractalValueRidgeMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleFractal Value RidgeMulti Example";
  }
