 ...
 */
public class ModuleBasisFunctionWhiteMultiExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionWhiteMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction White Multi Example";
  }
