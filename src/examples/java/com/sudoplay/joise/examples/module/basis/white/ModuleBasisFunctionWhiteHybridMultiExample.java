 ...
 */
public class ModuleBasisFunctionWhiteHybridMultiExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionWhiteHybridMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction White HybridMulti Example";
  }
