 ...
 */
public class ModuleBasisFunctionSimplexHybridMultiExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionSimplexHybridMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction Simplex HybridMulti Example";
  }
