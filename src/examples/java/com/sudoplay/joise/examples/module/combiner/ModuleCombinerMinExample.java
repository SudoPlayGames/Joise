 ...
 */
public class ModuleCombinerMinExample extends
    AbstractSplitExample {

  static {
    EXAMPLE_CLASS = ModuleCombinerMinExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleCombiner Min Example";
  }
  ...
  protected void run(SplitCanvas canvas) {
    ...
    moduleCombiner.setType(ModuleCombiner.CombinerType.MIN);
    ...
    canvas.updateImage(
        ...
        "moduleCombiner: min", moduleCombiner
    );
  }
}
