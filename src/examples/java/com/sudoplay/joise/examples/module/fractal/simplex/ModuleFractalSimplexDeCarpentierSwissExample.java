package com.sudoplay.joise.examples.module.fractal.simplex;
 ...
 */
public class ModuleFractalSimplexDeCarpentierSwissExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleFractalSimplexDeCarpentierSwissExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleFractal Simplex deCarpentierSwiss Example";
  }
