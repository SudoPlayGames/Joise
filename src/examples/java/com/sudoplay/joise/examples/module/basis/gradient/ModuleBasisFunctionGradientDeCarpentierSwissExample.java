 ...
 */
public class ModuleBasisFunctionGradientDeCarpentierSwissExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionGradientDeCarpentierSwissExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction Gradient deCarpentierSwiss Example";
  }
