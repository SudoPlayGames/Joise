 ...
 */
public class ModuleBasisFunctionGradvalBillowExample extends
    AbstractSplitExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionGradvalBillowExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction GradVal Billow Example";
  }
