 ...
 */
public class ModuleCombinerMultExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleCombinerMultExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleCombiner Mult Example";
  }
  ...
  protected void run(SplitCanvas canvas) {
    ...
    moduleCombiner.setType(ModuleCombiner.CombinerType.MULT);
    ...
    canvas.updateImage(
        ...
        "moduleCombiner: mult", moduleCombiner
    );
  }
}
