 ...
 */
public class ModuleBasisFunctionGradvalMultiExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionGradvalMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction GradVal Multi Example";
  }
