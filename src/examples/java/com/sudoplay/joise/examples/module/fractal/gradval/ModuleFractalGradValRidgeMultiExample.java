 ...
 */
public class ModuleFractalGradValRidgeMultiExample extends
    AbstractSplitExample {

  static {
    EXAMPLE_CLASS = ModuleFractalGradValRidgeMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleFractal GradVal RidgeMulti Example";
  }
