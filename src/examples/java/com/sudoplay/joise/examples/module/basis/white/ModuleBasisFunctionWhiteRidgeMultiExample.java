 ...
 */
public class ModuleBasisFunctionWhiteRidgeMultiExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionWhiteRidgeMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction White RidgeMulti Example";
  }
