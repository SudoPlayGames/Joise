 ...
 */
public class ModuleBasisFunctionGradvalDeCarpentierSwissExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionGradvalDeCarpentierSwissExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction GradVal deCarpentierSwiss Example";
  }
