 ...
 */
public class ModuleBasisFunctionGradvalHybridMultiExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionGradvalHybridMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction GradVal HybridMulti Example";
  }
