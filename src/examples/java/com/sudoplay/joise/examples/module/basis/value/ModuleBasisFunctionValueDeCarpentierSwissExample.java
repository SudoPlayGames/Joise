package com.sudoplay.joise.examples.module.basis.value;
 ...
 */
public class ModuleBasisFunctionValueDeCarpentierSwissExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionValueDeCarpentierSwissExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction Value deCarpentierSwiss Example";
  }
  ...
  protected void run(SplitCanvas canvas) {
    ...
    genNone.setAllSourceBasisTypes(ModuleBasisFunction.BasisType.VALUE);
    ...
    genLinear.setAllSourceBasisTypes(ModuleBasisFunction.BasisType.VALUE);
    ...
    genCubic.setAllSourceBasisTypes(ModuleBasisFunction.BasisType.VALUE);
    ...
    genQuintic.setAllSourceBasisTypes(ModuleBasisFunction.BasisType.VALUE);
