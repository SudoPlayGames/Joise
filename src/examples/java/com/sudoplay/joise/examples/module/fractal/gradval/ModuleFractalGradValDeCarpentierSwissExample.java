package com.sudoplay.joise.examples.module.fractal.gradval;
 ...
 */
public class ModuleFractalGradValDeCarpentierSwissExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleFractalGradValDeCarpentierSwissExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleFractal GradVal deCarpentierSwiss Example";
  }
