 ...
 */
public class ModuleBasisFunctionValueBillowExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionValueBillowExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction Value Billow Example";
  }
