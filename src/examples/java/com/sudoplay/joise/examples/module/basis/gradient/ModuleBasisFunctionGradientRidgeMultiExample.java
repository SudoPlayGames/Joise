 ...
 */
public class ModuleBasisFunctionGradientRidgeMultiExample extends
    AbstractSplitExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionGradientRidgeMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction Gradient RidgeMulti Example";
  }
