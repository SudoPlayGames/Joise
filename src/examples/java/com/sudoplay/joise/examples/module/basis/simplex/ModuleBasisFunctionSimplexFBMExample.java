 ...
 */
public class ModuleBasisFunctionSimplexFBMExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionSimplexFBMExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction Simplex FBM Example";
  }
