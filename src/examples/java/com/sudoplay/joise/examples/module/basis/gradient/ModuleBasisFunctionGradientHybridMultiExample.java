 ...
 */
public class ModuleBasisFunctionGradientHybridMultiExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionGradientHybridMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction Gradient HybridMulti Example";
  }
