 ...
 */
public class ModuleFractalWhiteRidgeMultiExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleFractalWhiteRidgeMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleFractal White RidgeMulti Example";
  }
