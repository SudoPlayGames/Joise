 ...
 */
public class ModuleFractalSimplexBillowExample extends
    AbstractSplitExample {

  static {
    EXAMPLE_CLASS = ModuleFractalSimplexBillowExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleFractal Simplex Billow Example";
  }
