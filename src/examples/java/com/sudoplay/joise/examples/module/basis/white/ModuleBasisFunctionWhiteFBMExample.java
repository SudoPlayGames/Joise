 ...
 */
public class ModuleBasisFunctionWhiteFBMExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionWhiteFBMExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction White FBM Example";
  }
