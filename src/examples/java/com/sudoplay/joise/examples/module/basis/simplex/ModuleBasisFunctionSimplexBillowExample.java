 ...
 */
public class ModuleBasisFunctionSimplexBillowExample extends
    AbstractSplitExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionSimplexBillowExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction Simplex Billow Example";
  }
