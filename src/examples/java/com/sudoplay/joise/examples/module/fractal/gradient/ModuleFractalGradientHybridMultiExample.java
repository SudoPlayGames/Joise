 ...
 */
public class ModuleFractalGradientHybridMultiExample extends
    AbstractSplitExample {

  static {
    EXAMPLE_CLASS = ModuleFractalGradientHybridMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleFractal Gradient HybridMulti Example";
  }
