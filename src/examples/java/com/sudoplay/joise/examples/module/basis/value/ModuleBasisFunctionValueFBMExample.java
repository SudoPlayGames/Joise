 ...
 */
public class ModuleBasisFunctionValueFBMExample extends
    AbstractSplitExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionValueFBMExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction Value FBM Example";
  }
