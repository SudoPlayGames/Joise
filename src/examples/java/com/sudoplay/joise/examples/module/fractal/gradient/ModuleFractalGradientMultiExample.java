 ...
 */
public class ModuleFractalGradientMultiExample extends
    AbstractSplitExample {

  static {
    EXAMPLE_CLASS = ModuleFractalGradientMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleFractal Gradient Multi Example";
  }
