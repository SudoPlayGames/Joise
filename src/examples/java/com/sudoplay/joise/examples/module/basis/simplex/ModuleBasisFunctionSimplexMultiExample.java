 ...
 */
public class ModuleBasisFunctionSimplexMultiExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionSimplexMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction Simplex Multi Example";
  }
