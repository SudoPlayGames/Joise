 ...
 */
public class ModuleBasisFunctionGradientMultiExample extends
    AbstractSplitExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionGradientMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction Gradient Multi Example";
  }
