 ...
 */
public class ModuleBasisFunctionGradientFBMExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionGradientFBMExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction Gradient FBM Example";
  }
