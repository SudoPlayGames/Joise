 ...
 */
public class ModuleFractalGradValBillowExample extends
    AbstractSplitExample {

  static {
    EXAMPLE_CLASS = ModuleFractalGradValBillowExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleFractal GradVal Billow Example";
  }
