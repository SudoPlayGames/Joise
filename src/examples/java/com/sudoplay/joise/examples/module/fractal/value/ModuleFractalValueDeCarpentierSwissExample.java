 ...
 */
public class ModuleFractalValueDeCarpentierSwissExample extends
    AbstractSplitExample {

  static {
    EXAMPLE_CLASS = ModuleFractalValueDeCarpentierSwissExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleFractal Value deCarpentierSwiss Example";
  }
