 ...
 */
public class ModuleBasisFunctionGradvalRidgeMultiExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionGradvalRidgeMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction GradVal RidgeMulti Example";
  }
