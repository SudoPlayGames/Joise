 ...
 */
public class ModuleFractalGradientRidgeMultiExample extends
    AbstractSplitExample {

  static {
    EXAMPLE_CLASS = ModuleFractalGradientRidgeMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleFractal Gradient RidgeMulti Example";
  }

  @Override
  protected void run(SplitCanvas canvas) {
    BasisType basisType = BasisType.GRADIENT;
    FractalType fractalType = FractalType.RIDGEMULTI;
