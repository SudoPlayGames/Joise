 ...
 */
public class ModuleNormalizedCoordsExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleNormalizedCoordsExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleNormalizedCoords Example";
  }
  ...
  protected void run(SplitCanvas canvas) {
    ...
    moduleNormalizedCoords.setSource(moduleAutoCorrect);

    canvas.updateImage(
        "source", moduleAutoCorrect,
        "normalized", moduleNormalizedCoords
    );
  }
