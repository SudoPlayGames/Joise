 ...
 */
public class ModuleFractalWhiteDeCarpentierSwissExample extends
    AbstractSplitExample {

  static {
    EXAMPLE_CLASS = ModuleFractalWhiteDeCarpentierSwissExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleFractal White deCarpentierSwiss Example";
  }
