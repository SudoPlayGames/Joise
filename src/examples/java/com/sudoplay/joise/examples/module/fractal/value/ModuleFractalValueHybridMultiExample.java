 ...
 */
public class ModuleFractalValueHybridMultiExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleFractalValueHybridMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleFractal Value HybridMulti Example";
  }
