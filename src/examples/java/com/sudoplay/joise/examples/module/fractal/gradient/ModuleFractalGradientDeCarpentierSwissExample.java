package com.sudoplay.joise.examples.module.fractal.gradient;
 ...
 */
public class ModuleFractalGradientDeCarpentierSwissExample extends
    AbstractExample {

  static {
    EXAMPLE_CLASS = ModuleFractalGradientDeCarpentierSwissExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleFractal Gradient deCarpentierSwiss Example";
  }

  @Override
  protected void run(SplitCanvas canvas) {
    BasisType basisType = BasisType.GRADIENT;
    FractalType fractalType = FractalType.DECARPENTIERSWISS;
