 ...
 */
public class ModuleFractalWhiteHybridMultiExample extends
    AbstractSplitExample {

  static {
    EXAMPLE_CLASS = ModuleFractalWhiteHybridMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleFractal White HybridMulti Example";
  }
