package com.sudoplay.joise.examples.module.basis.white;
 ...
 */
public class ModuleBasisFunctionWhiteDeCarpentierSwissExample extends
    AbstractSplitExample {

  static {
    EXAMPLE_CLASS = ModuleBasisFunctionWhiteDeCarpentierSwissExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleBasisFunction White deCarpentierSwiss Example";
  }
  ...
  protected void run(SplitCanvas canvas) {
    ...
    genNone.setAllSourceBasisTypes(ModuleBasisFunction.BasisType.WHITE);
    ...
    genNone.setType(ModuleFractal.FractalType.DECARPENTIERSWISS);
    genNone.setSeed(42);
    ...
    genLinear.setAllSourceBasisTypes(ModuleBasisFunction.BasisType.WHITE);
    ...
    genLinear.setType(ModuleFractal.FractalType.DECARPENTIERSWISS);
    ...
    genCubic.setAllSourceBasisTypes(ModuleBasisFunction.BasisType.WHITE);
    ...
    genCubic.setType(ModuleFractal.FractalType.DECARPENTIERSWISS);
    genCubic.setSeed(42);
    ...
    genQuintic.setAllSourceBasisTypes(ModuleBasisFunction.BasisType.WHITE);
    ...
    genQuintic.setType(ModuleFractal.FractalType.DECARPENTIERSWISS);
