 ...
 */
public class ModuleFractalGradValHybridMultiExample extends
    AbstractSplitExample {

  static {
    EXAMPLE_CLASS = ModuleFractalGradValHybridMultiExample.class;
  }

  @Override
  protected String getWindowTitle() {
    return "ModuleFractal GradVal HybridMulti Example";
  }
