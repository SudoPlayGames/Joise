...
public class WorkerNoise4Value implements
    WorkerNoise4 {

  private byte[] buffer;

  public WorkerNoise4Value() {
    this.buffer = new byte[24];
  }

  @Override
  public double calculate(double x, double y, double z, double w, int ix, int iy, int iz, int iw, long seed) {
    ...
    double noise = (double) hash * Noise.INV_BYTEVAL;
